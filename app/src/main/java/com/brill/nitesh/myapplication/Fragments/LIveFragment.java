 ...
 */
public class LIveFragment extends Fragment implements YouTubePlayer.OnInitializedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mYoutubePlayerFragment.initialize("AIzaSyBdizN4LTSo0bVOy_3a23VSgf2xddNVgFI", this);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean wasRestored) {
        if (!wasRestored) {
            youTubePlayer.cueVideo("hS5CfP8n_js");
        }
    }
