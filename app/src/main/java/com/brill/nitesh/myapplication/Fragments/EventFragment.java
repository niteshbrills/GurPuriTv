...
public class EventFragment extends Fragment implements AdvancedWebView.Listener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        wv_WebView.loadUrl("http://www.gurpuritv.com/Events.php");
        return rootView;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof ContactUsFragment.OnFragmentInteractionListener) {
            mListener = (EventFragment.OnFragmentInteractionListener) context;
        } else {
